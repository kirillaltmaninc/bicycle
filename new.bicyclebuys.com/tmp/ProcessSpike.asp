<%
	...
	sql = "SELECT Orders.*, Customers.* , c.CountryAbbreviation cCountry, sC.CountryAbbreviation sCountry "
	sql = sql & "FROM Orders INNER JOIN Customers ON Orders.OrdCustID = Customers.CustomerID "
	sql = sql & " Left Outer Join Country C on c.Country = Customers.CustCountry Left Outer Join Country sC on sc.Country =  Orders.ShipCountry "
	sql = sql & " Where OrderID = " & OrderID
	sql = sql & " For Browse" 
	...
	if not rs.eof then
		...
		if not isnull(rs.fields("cCountry")) then
			CustCountry = rs.fields("cCountry")
		else
		...
		if not isnull(rs.fields("sCountry")) then
        	  ShipCountry = rs.Fields("sCountry")
		else
      ...
      <table border="0" cellpadding="2" cellspacing="0" width="800" bgcolor="#3399FF" style="border-collapse: collapse" bordercolor="#111111">
        ...
        <tr>
          <td align="right"><b><font face="Verdana" size="2"> Expiration Month:
            (mm)*</font></b></td>
          <td><font face="Verdana" size="2" >
            <input maxLength=2 size=2 name="month" tabindex="8" value="<%=CreditCardExpDate_Month%>">
            </font></td>
        </tr>
        <tr>
          <td align="right"><b><font face="Verdana" size="2"> Expiration Year:
            (yy)*</font></b></td>
          <td><font face="Verdana" size="2">
            <input maxLength=4 size=2 name="year" tabindex="9" value="<%=CreditCardExpDate_Year%>" >
            </font></td>
        </tr>
        <tr>
          <td align="right"><b><font face="Verdana" size="2">Amount*: </font></b></td>
          <td><font face="Verdana" size="2">
            <input maxlength=8 size=8 name="transactionamount" tabindex="10" value="<%=PaymentAmount%>" >
            </font></td>
        </tr>
        <tr>
          <td align="right"><b><font face="Verdana" size="2">Phone*:</font></b></td>
          <td><font face="Verdana" size="2">
            <input maxlength=20 size=15 name="shiptophone" tabindex="11" value="<%=CustPhone%>">
            </font></td>
        </tr>
        <tr>
          <td align="right"><b><font face="Verdana" size="2"> E-mail*:</font></b></td>
          <td><font face="Verdana" size="2">
            <input maxlength=50 size=35 name="email" tabindex="12" value="<%=custEmail%>">
            </font></td>
        </tr>
        <tr>
...
<input type=hidden name="ShipName" tabindex="3" value="<%=ShipName%>">
<input type=hidden name="ShipCompany" tabindex="3" value="<%=ShipCompanyName%>">
<input type=hidden name="ShipAddress1" tabindex="3" value="<%=ShipAddress%>">
<input type=hidden name="ShipCity" tabindex="3" value="<%=ShipCity%>">
<input type=hidden name="ShipStateProvince" tabindex="3" value="<%=ShipStateOrProvince%>">
<input type=hidden name="ShipZipPostal" tabindex="3" value="<%=ShipPostalCode%>">
<input type=hidden name="ShipPhoneNumber" tabindex="3" value="<%=ShipPhoneNumber%>">
<input type=hidden name="ShipEmail" tabindex="3" value="<%=CustEmail%>">
<input type=hidden name="ShipCountry" tabindex="3" value="<%=ShipCountry%>">
</div>
