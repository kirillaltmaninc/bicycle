...
' they jump into the middle of the site
  ...
  FileDSN ="Provider=SQLNCLI10;Server=10.0.0.66;Database=BBC_Prod;DataTypeCompatibility=80;User ID =webUserprod;Password=bbcwebUserprod;DataTypeCompatibility=80;"
...
SUB Session_OnStart()
	...
	session("lastrundate")=""
Application.Lock
	Application("DayCount")=Application("DayCount")+ 1
Application.UnLock
...
'	End If
   ...
   vReferral = Request.ServerVariables("HTTP_REFERER")
	Application("Last10") = Request.ServerVariables("REMOTE_ADDR") & ": " &  left(vReferral, 40)  & "<br>" & left(application("Last10"),2000)
