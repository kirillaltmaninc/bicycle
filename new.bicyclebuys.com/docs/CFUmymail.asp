...
<head>
    <title>CycleFast USA - NY's Largest Bicycle Superstore</title>
    <link href="menu.css" rel="stylesheet" type="text/css" />
</head>
<body style="text-alig:center;">
    <center>
                ...
                <tr>
                    <td style="margin-left: 100px">
                         <table style="text-align: left; width: 400px">
                            <tr>
                                <td colspan="2">
                                    <a href="http://www.cyclefastusa.com">
                                        <img src="http://www.cyclefastusa.com/Images/CycleFastUSAlogo.jpg" /><br>
                                        <br>
                                    </a>
                                </td>
                            </tr>
	...
	<br><br></td>
        ...
        <div id="footer"> <img src="http://www.cyclefastusa.com/Images/Footer.png" width="960" height="75" border="0" usemap="#Map" />
    <map name="Map" id="Map">
      <area shape="rect" coords="69,25,147,55" href="http://www.cyclefastusa.com/aboutus.htm" target="_top" alt="About Us" />
      <area shape="rect" coords="291,24,389,56" href="http://www.cyclefastusa.com/Manufacturers.htm" target="_top" alt="Manufacturers We Represent" />
      <area shape="rect" coords="185,24,254,54" href="http://www.cyclefastusa.com/Contact.htm" target="_top" alt="Contact Us" />
      <area shape="rect" coords="776,27,866,59" href="http://www.cyclefastusa.com/StoreNews.htm" target="_top" alt="Latest Store News" />
      <area shape="rect" coords="421,26,497,57" href="http://www.cyclefastusa.com/register.asp" target="_blank" alt="Register For Sales" />
      <area shape="rect" coords="540,25,619,57" href="http://www.cyclefastusa.com/Specials.htm" target="_top" alt="Special Sale Items" />
      <area shape="rect" coords="650,27,741,56" href="http://www.cyclefastusa.com/StorePolicy.htm" target="_top" alt="Store Policies" />
    </map>
  </div>
    </center>
