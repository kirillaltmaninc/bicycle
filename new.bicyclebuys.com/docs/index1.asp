...
<!--#INCLUDE file="includes/common1.asp"-->
<!--#INCLUDE file="includes/IndexFunctionsP.asp"-->
<!--#INCLUDE file="includes/redirects.asp"-->
<%
Dim leftColumn, leftColumnMob
leftColumn="/templates/bb/tmpl/home_base_leftColumn.html"
leftColumnMob="/templates/bb/tmpl/home_base_leftColumnMob.html"
...
'end if
         with objTemplate
            ...
            .AddToken "leftColumn", 3, leftColumn
            .parseTemplateFile
         end with
...
dim rsSubCatIDSC, vSQLsubcategorySC, vSQLsubcategoryResSC
           Set rsSubCatIDSC = Server.CreateObject("ADODB.Recordset")
          
 		       
 vSQLsubcategoryResSC = "select Subcategory.SubCategory from Subcategory INNER JOIN products on SubCategory.SubCatID = Products.SubCatID and Products.SKU = '"&oProd1.pFields.item("SKU")&"'"
                 rsSubCatIDSC.open vSQLsubcategoryResSC, conn
         
                if not rsSubCatIDSC.eof then
                    vSQLsubcategorySC=rsSubCatIDSC("SubCategory")
                end if
            ...
            rsSubCatIDSC.close
                ...
                if mTracking ="goog" or  mTracking ="googUK" then
             	    .TemplateFile = TMPLDIR & "productGoog.html"
             	    .AddToken "title", 1, oProd1.pfields.Item("description") & " | Search Results"
             	    vProdMeta = vProdMeta & " | Search Results"
               else
            	    .TemplateFile = TMPLDIR & "productLeft.html"
					.AddToken "subCategoryName", 1, getsubcatdisp(vSQLsubcategorySC)
