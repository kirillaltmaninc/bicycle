...
<%
    ...
    elseif request.Form("register")<>"" then
        if not SaveLoadUser(1) then
            ...
            msg = "*** Succsessfully Subscribed: " & email
        end if
...
<body>
    <center>
        <form id="form1" action="mymailnew.asp" method="post">
            &nbsp;<table width="760px" border="0" cellpadding="0" cellspacing="0" class="border" style="text-align: left;">
				...
				<tr>
                                <td colspan="2">
                                    To Subscribe to future e-mail enter your e-mail and click below...
                                 </td>
                            ...
                            <tr>
                                ...
                                <td> <input name="register" type="submit" value="Subscribe" style="width: 200px; position: relative" /><%=msg%>  				                                                                     
				</td>
