...
<BODY onLoad="MM_timelinePlay('Timeline1','divScroll',150,1);MM_timelinePlay('Timeline2','animateplace',230,0)">
    ...
    <div>
        <a href="images/FreeShipping200.tif">images/FreeShipping200.tif</a>   
    </div>
    </form>
    <img src="images/FreeShip200b.gif" />
  ...
  <%
   ...
   conn.Open dsn
    ...
    if (lastrundate <> 2) then
        ...
        & "WHERE (Active LIKE 'Y' or Active like 'n') " _
 ...
 <%
    ...
    function getSlider(sType)  
        ...
        if lastrundate = date() and 1=3 then 
        else
        'if (lastrundate <> 1 ) then
