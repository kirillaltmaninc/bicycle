...
<!--#INCLUDE file="includes/IndexFunctionsPM.asp"-->
<%
...
'response.write(Is_Mobile)
dim strUA
strUA = Request.ServerVariables("HTTP_USER_AGENT")

		with objTemplate
            if inStr(strUA, "Mobile Safari") > 0 or inStr(strUA, "Android") > 0  or inStr(strUA, "CLDC") > 0  or inStr(strUA, "iPhone") > 0  or inStr(strUA, "BlackBerry") > 0  or inStr(strUA, "CLDC") > 0 then 
				.TemplateFile = TMPLDIR & "hhome_base_mobile_neil.html"
			else
				.TemplateFile = TMPLDIR & "home_baseMReg.html"
			end if
