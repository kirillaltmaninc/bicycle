...
'************************
         ...
         vOUT104 = "" _
			  ...
			  & vItemOptions & "<input name=""SUBMIT"" VALUE=""ADD"" type=image src=""images/addtocart.png"" alt=""" & replace("Buy " & oProd1.pfields.Item("description"),"""","'") & """ style=""margin: 5px 0 0 0;"">" _
...
'************************
			 ...
			 vOUT104 = "" _
				  ...
				  & vItemOptions & "<input name=""SUBMIT"" VALUE=""ADD"" type=image src=""/images/addtocart.png"" alt=""" & replace("Buy " & pfields2.Item("description"),"""","'") & """ style=""margin: 5px 0 0 0;"">" _
    ...
    sub getRecentlyViewed()
        ...
        dim skus
			...
			skus = left(skus,len(skus)-1)
				...
				descUrlPV = replace(descUrlPV," ","-")
					vOUT100 = vOUT100 & "<img src=""images/orange-arrow.gif"" width=""10"" height=""9"" border=0 alt="">""> <a href=""/item/" & rs2("SKU") & "/" & lcase(descUrlPV) & """>" & rs2("description") & "</a><br>"
					rs2.movenext
				wend
				counter = counter + 1
				rs2.close
...
'           response.write "<hr>"  & oProd1.pfields.Item("ischildorparentoritem")
    ...
    t = t & "<LINK rel=stylesheet type=""text/css"" href=""menu.css"">" & vbcrlf
		...
		dim rsSubCatID, vSQLsubcategory, vSQLsubcategoryRes
