...
<% 
      ...
      Dim vCheckEmpty, pFields, RopCnt
      vCheckEmpty = ""
'response.write( vThisProto & vThisServer )
      ...
      if  last_added_id <> ""  then 
			...
			while not rs2.EOF
				...
				vOUT103 = vOUT103 & "<TD class=""tiny"" align=center valign=top><a href=""/item/" & rs2("SKU") & "/chkout""><img src=""" & resizepic("/productimages/" & rs2("picture"), rs2("Width_Small"), rs2("Height_Small")) & """ border=""0""></a></td>"
				vOUT102 = vOUT102 & "<TD class=""popularfoot"" align=center valign=top>"
				vOUT102 = vOUT102 & "<a href=""/item/" & rs2("SKU") & "/chkout"">" & rs2("description") & "</a>" & "<BR><span class=""price"">YOU PAY: " & formatcurrency(rs2("price"), 2, 0, 0) & "</span><br><a href=""/item/" & rs2("SKU") & "/chkout"">MORE INFO</a><br />"
				vOUT102 = vOUT102 & ""
