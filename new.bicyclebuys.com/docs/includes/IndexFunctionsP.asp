...
'end if
            ...
            TestIT = TestIT & "aMostPop[" & counter & "]='" & replace( replace(replace(pfields2.Item("marketingDescription"),chr(13), ""), chr(10),""),"'","\'") & "';" & chr(13)
				...
				vvMSRP =  msrp(rs2)
				vOUT103 = vOUT103 & "<TD class=""tiny"" align=center valign=top><a href=""/item/" & rs2("SKU") & "/" & lcase(descUrl) &"""><img src=""" & resizepic("/productimages/" & rs2("picture"), rs2("Width_Small"), rs2("Height_Small")) & """ border=""0"" alt=""" & replace(rs2("description"),"""","&quot;")  & """   ></a></td>"
