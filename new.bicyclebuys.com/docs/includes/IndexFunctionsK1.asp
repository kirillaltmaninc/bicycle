...
'			end if
			...
			'end if
			'showonlybrands = showonlybrands & "</select>" 
			'showonlybrands = showonlybrands & "</select>" & "&nbsp;<span style=""color:#336699;font-weight:bold;font-size:13px;padding: 0px 0px 0px 0px;"">" & replace(Request.querystring("m"), "_", " ") & "</span>"
			
			dim SortValue, showonlybrandsMvalue, showonlybrandsPricevalue			
			showonlybrandsMvalue = Request.querystring("m")
			showonlybrandsPricevalue = Request.querystring("price")
			'response.Write(showonlybrandsMvalue)
			if ( showonlybrandsMvalue <> "") then 
			    showonlybrands = showonlybrands & "</select>" & "<br/><span style=""color:#336699;font-weight:bold;font-size:13px;padding: 0px 0px 0px 135px;"">Showing:&nbsp;" & replace(Request.querystring("m"), "_", " ") & "</span>"
			elseif ( showonlybrandsPricevalue <> "") then 
			    showonlybrands = showonlybrands & "</select>" & "&nbsp;<span style=""color:#336699;font-weight:bold;font-size:13px;padding: 0px 0px 0px 0px;"">" & showonlybrandsPricevalue & "</span>"
			else
			    showonlybrands = showonlybrands & "</select>"
			end if
			'SortValue = SortValue & "</select>" & "<br/><span style=""color:#336699;font-weight:bold;font-size:17px;padding: 0px 0px 0px 125px;"">Showing:&nbsp;" & replace(Request.querystring("m"), "_", " ") & "</span>"
			 
			'if ( showonlybrandsMvalue <> "") then 
		    'response.Write("<br/><span style=""color:#336699;font-weight:bold;font-size:17px;padding: 0px 0px 0px 125px;"">Showing:&nbsp;" & replace(Request.querystring("m"), "_", " ") & "</span>")
		    'end if
			'showonlybrands = showonlybrands & "</select>" & "<br/><span style=""color:#336699;font-weight:bold;font-size:17px;padding: 0px 0px 0px 125px;"">Showing:&nbsp;" & replace(Request.querystring("m"), "_", " ") & "</span>"
            ...
            if vSection = "search" then
    	     ...
    	     elseif ( vSection = "newitems" OR (vSection = "allmfg" AND vDept = "" AND vManufacturer <> "")) then
				...
				.AddToken "showonly", 1, showonlybrands
				.AddToken "pagenav", 1, pagenavout
				.AddToken "SortValue", 1, SortValue
