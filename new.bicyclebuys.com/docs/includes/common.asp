		...
		vPrefURL = "/item/"
             vOUT1 = vOUT1 & "<tr><td> <FORM METHOD=""post"" action=""https://www.bicyclebuys.com/addtocart/"">" _
              ...
              & "<INPUT TYPE=""hidden"" NAME=""mSpecialPricing"" VALUE=""" & pFields.Item("mSpecialPricing") & """>" _
               & "     <a href=""" & vPrefURL & pFields.item("SKU")  & "/" & lcase(descUrl) & """><img src=""" & resizepic("/productimages/" & pFields.item("picture"), pFields.item("Width_Small"), pFields.item("Height_Small")) & """ border=""0"" alt=""" & replace(pFields.item("description"),"""","&quot;") &  """   ></a></TD>" _
